<%@ page import="com.abc.manager.dao.EmpMapper" %>
<%@ page import="com.abc.manager.entity.Emp" %>
<%@ page import="java.util.List" %>
<%@ page import="com.abc.manager.service.EmpService" %>
...
<body>
<!-- 注册表单 -->
<form  method="post" action="/adminEmp/update" style="margin-left:500px;margin-top:200px;">
    <%
    ...
    <div class="form-horizontal">
        ...
        <label class="radio-inline">
            <input type="radio" name="role" value="9" checked />系统管理员
        </label>
        <label class="radio-inline">
