        ...
        <div class="col-md-2"  >
            <ul>
                ...
                <li class="first-li"><a>考勤管理</a>
                    <ul class="sub-li" style="display: none;">
                        <li><a href="${pageContext.request.contextPath}/file/upload" ></a></li>
                        <li><a href="${pageContext.request.contextPath}/attend/getAll.do" >考勤详情</a></li>
                        <li>考勤查询</li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="col-md-6">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <li><a href="${pageContext.request.contextPath}/attend/getAll.do?pageNum=1">首页</a></li>

                        <!--上一页-->
                        <li>
                            <c:if test="${pageInfo.hasPreviousPage}">
                                <a href="${pageContext.request.contextPath}/attend/getAll.do?pageNum=${pageInfo.pageNum-1}" aria-label="Previous">
                        ...
                        <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                            ...
                            <c:if test="${page_num != pageInfo.pageNum}">
                                <li><a href="${pageContext.request.contextPath}/attend/getAll.do?pageNum=${page_num}">${page_num}</a></li>
                            </c:if>
                        </c:forEach>
                        ...
                        <li>
                            <c:if test="${pageInfo.hasNextPage}">
                                <a href="${pageContext.request.contextPath}/attend/getAll.do?pageNum=${pageInfo.pageNum+1}"
                                   aria-label="Next">
                                    <span aria-hidden="true">»</span>
                                </a>
                            </c:if>
                        ...
                        <li><a href="${pageContext.request.contextPath}/attend/getAll.do?pageNum=${pageInfo.pages}">尾页</a></li>
                    </ul>
                </nav>
            </div>
