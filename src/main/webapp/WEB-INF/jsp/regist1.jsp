...
<head>
    ...
    <script type="text/javascript" src="static/js/kaptcha.js"></script>
...
<!-- 注册表单 -->
<form  id="insert_modal" class="form-horizontal" style="margin-left:500px;margin-top:200px;">
    ...
    <div class="form-group">
        ...
        <input type="text"  class="form-control"
               id="insert_phonenum" placeholder="请输入电话号码" name="phonenum" style="display:inline;width:200px;" autocomplete="off" />
    </div>
    ...
    <button type="submit" class="btn btn-primary" id="user_insert_btn">确认注册</button>
</form>
